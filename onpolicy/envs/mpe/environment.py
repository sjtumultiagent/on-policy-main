...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
        ...
        # set collaborative or seperated / continuous or discrete
        ...
        for agent in self.agents:
            ...
            # total action space, combine two action spaces to one action space
    ...
    # reset the envirionment after a epoch
    def reset(self):
        self.current_step = 0
        # reset world
