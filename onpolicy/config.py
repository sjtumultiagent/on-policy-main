...
def get_config():
    ...
    parser.add_argument("--num_env_steps", type=int, default=2e4,
                        help='Number of environment steps to train (default: 10e6)')
    parser.add_argument("--user_name", type=str, default='allen',help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    parser.add_argument("--gif_dir", type=str, default=r"E:\vscode\on-policy-main\onpolicy\scripts\results\gif", help="by default, do not save render video. If set, save video.")
    ...
    # pretrained parameters
    parser.add_argument("--model_dir", type=str, default=r"E:\vscode\on-policy-main\onpolicy\scripts\results\MPE\simple_spread\rmappo\check\run1\models", help="by default None. set the path to pretrained model.")
